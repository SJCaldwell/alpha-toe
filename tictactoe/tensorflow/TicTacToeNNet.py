...
class TicTacToeNNet():
    def __init__(self, game, args):
        ...
        with self.graph.as_default(): 
            ...
            h_conv4 = Relu(BatchNormalization(self.conv2d(h_conv3, args.num_channels, 'valid'), axis=3, training=self.isTraining))    # batch_size  x (board_x-2) x (board_y-2) x num_channels
